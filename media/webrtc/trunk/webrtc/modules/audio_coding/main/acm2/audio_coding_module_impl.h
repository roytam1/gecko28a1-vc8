...
class AudioCodingModuleImpl : public AudioCodingModule {
 public:
  ...
  virtual int SetReceivedEstimatedBandwidth(const int bw);
  ...
  int SetFECStatus(const bool enable_fec);
  ...
  int SetVAD(const bool enable_dtx = true,
  ...
  // tone.
  int SetDtmfPlayoutStatus(const bool enable) { return 0; }
  ...
  int SetPlayoutMode(const AudioPlayoutMode mode);
  ...
  int ReplaceInternalDTXWithWebRtc(const bool use_webrtc_dtx);
