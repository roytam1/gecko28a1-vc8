...
CodeGenerator::generateArgumentsChecks(bool bailout)
{
    ...
    // memory pages in-between.  This is corner-case code for situations where the
    // Ion frame data for a piece of code is very large.  To handle this special case,
    // for frames over 1k in size, we allocate memory on the stack incrementally,
    // touching it as we go.
